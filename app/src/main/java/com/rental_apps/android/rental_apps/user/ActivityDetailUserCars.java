...
public class ActivityDetailUserCars extends AppCompatActivity implements InitComponent, View.OnClickListener{
    ...
    public void initUI() {
        ...
        Drawable cartIcon= ContextCompat.getDrawable(mContext, R.drawable.ic_nav_shop);


        action_mobil.setImageDrawable(DrawableColor.setColor(cartIcon, Color.parseColor("#fff")));
    ...
    public void initValue() {
        ...
        price.setText("Rpa. "+String.format("%,.2f", Double.parseDouble(car.getHARGAMOBIL().toString())));
